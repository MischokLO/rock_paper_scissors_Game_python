...
PlayerChoices = ["RandomPlayer", "HumanPlayer", "CyclePlayer", "ReflectPlayer"]

if __name__ == '__main__':
    p1 = input("Select a Player from HumanPlayer, RandomPlayer, CyclePlayer or"
               " ReflectPlayer: ")
    print("\n")
    while p1 not in PlayerChoices:
        p1 = input("Invalid Playerchoise, choose a valid one from HumanPlayer,"
                   " RandomPlayer, CyclePlayer or ReflectPlayer: ")
        print("\n")
    p2 = input("Select a second Player from HumanPlayer, RandomPlayer,"
               "CyclePlayer or ReflectPlayer: ")
    print("\n")
